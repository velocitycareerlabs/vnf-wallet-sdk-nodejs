/**
 * Created by Michael Avoyan on 23/07/2024.
 *
...
export class DeepLinkMocks {
    ...
    static OIDIssuerDid = "did:velocity:0xc257274276a4e539741ca11b590b9447b26a8051";
    ...
    static CredentialManifestRequestDecodedUriStr = decodeURIComponent(
        `https://devagent.velocitycareerlabs.io/api/holder/v0.6/org/${DeepLinkMocks.IssuerDid}/issue/get-credential-manifest?id=611b5836e93d08000af6f1bc&credential_types=PastEmploymentPosition&issuerDid=${DeepLinkMocks.IssuerDid}`
    );
    ...
    static CredentialManifestDeepLinkDevNetStr =
        `${DeepLinkMocks.DevNetProtocol}://issue?request_uri=${DeepLinkMocks.CredentialManifestRequestUriStr}`;
    static CredentialManifestDeepLinkTestNetStr =
        `${DeepLinkMocks.TestNetProtocol}://issue?request_uri=${DeepLinkMocks.CredentialManifestRequestUriStr}`;
    static CredentialManifestDeepLinkMainNetStr =
        `${DeepLinkMocks.MainNetProtocol}://issue?request_uri=${DeepLinkMocks.CredentialManifestRequestUriStr}`;

    static CredentialManifestDeepLinkDevNet = new VCLDeepLink(DeepLinkMocks.CredentialManifestDeepLinkDevNetStr);
    static CredentialManifestDeepLinkTestNet = new VCLDeepLink(DeepLinkMocks.CredentialManifestDeepLinkTestNetStr);
    static CredentialManifestDeepLinkMainNet = new VCLDeepLink(DeepLinkMocks.CredentialManifestDeepLinkMainNetStr);

    static PresentationRequestDeepLinkDevNet = new VCLDeepLink(DeepLinkMocks.PresentationRequestDeepLinkDevNetStr);
}